...
class _RegisterRequest implements RegisterRequest {
  const _RegisterRequest({required this.email, required this.password, this.firstname, this.lastname});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthResponse&&(identical(other.token, token) || other.token == token)&&(identical(other.userId, userId) || other.userId == userId));
}
...
@useResult
$Res call({
 String token,@JsonKey(name: 'user_id') String userId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token, @JsonKey(name: 'user_id')  String userId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token, @JsonKey(name: 'user_id')  String userId)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.token,_that.userId);case _:
  return null;
...
class _AuthResponse implements AuthResponse {
  const _AuthResponse({required this.token, @JsonKey(name: 'user_id') required this.userId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthResponse&&(identical(other.token, token) || other.token == token)&&(identical(other.userId, userId) || other.userId == userId));
}
...
mixin _$AuthState {
 ...
 bool get isAuthenticated; String? get userId; String? get email; String? get firstname; String? get lastname;
...
@override
int get hashCode => Object.hash(runtimeType,isAuthenticated,userId,email,firstname,lastname);

@override
String toString() {
  return 'AuthState(isAuthenticated: $isAuthenticated, userId: $userId, email: $email, firstname: $firstname, lastname: $lastname)';
}
...
@useResult
$Res call({
 bool isAuthenticated, String? userId, String? email, String? firstname, String? lastname
});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isAuthenticated = null,Object? userId = freezed,Object? email = freezed,Object? firstname = freezed,Object? lastname = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isAuthenticated,  String? userId,  String? email,  String? firstname,  String? lastname)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isAuthenticated,  String? userId,  String? email,  String? firstname,  String? lastname)?  $default,) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.isAuthenticated,_that.userId,_that.email,_that.firstname,_that.lastname);case _:
  return null;
...
class _AuthState implements AuthState {
  const _AuthState({this.isAuthenticated = false, this.userId, this.email, this.firstname, this.lastname});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isAuthenticated = null,Object? userId = freezed,Object? email = freezed,Object? firstname = freezed,Object? lastname = freezed,}) {
