...
mixin _$SyncRecord {
 ...
 String get id; String get remoteId; Map<String, dynamic> get data; DateTime get updatedAt; DateTime? get deletedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SyncRecord&&(identical(other.id, id) || other.id == id)&&(identical(other.remoteId, remoteId) || other.remoteId == remoteId)&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,remoteId,const DeepCollectionEquality().hash(data),updatedAt,deletedAt);

@override
String toString() {
  return 'SyncRecord(id: $id, remoteId: $remoteId, data: $data, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 String id, String remoteId, Map<String, dynamic> data, DateTime updatedAt, DateTime? deletedAt
});
...
/// Create a copy of SyncRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? remoteId = null,Object? data = null,Object? updatedAt = null,Object? deletedAt = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String remoteId,  Map<String, dynamic> data,  DateTime updatedAt,  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SyncRecord() when $default != null:
return $default(_that.id,_that.remoteId,_that.data,_that.updatedAt,_that.deletedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String remoteId,  Map<String, dynamic> data,  DateTime updatedAt,  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _SyncRecord():
return $default(_that.id,_that.remoteId,_that.data,_that.updatedAt,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String remoteId,  Map<String, dynamic> data,  DateTime updatedAt,  DateTime? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _SyncRecord() when $default != null:
return $default(_that.id,_that.remoteId,_that.data,_that.updatedAt,_that.deletedAt);case _:
  return null;
...
class _SyncRecord implements SyncRecord {
  const _SyncRecord({required this.id, required this.remoteId, required final  Map<String, dynamic> data, required this.updatedAt, this.deletedAt}): _data = data;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SyncRecord&&(identical(other.id, id) || other.id == id)&&(identical(other.remoteId, remoteId) || other.remoteId == remoteId)&&const DeepCollectionEquality().equals(other._data, _data)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,remoteId,const DeepCollectionEquality().hash(_data),updatedAt,deletedAt);
...
/// Create a copy of SyncRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? remoteId = null,Object? data = null,Object? updatedAt = null,Object? deletedAt = freezed,}) {
