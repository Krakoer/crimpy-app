...
class BuiltinTrainingModel {
  ...
  ///
  /// It decides what the athlete is asked, and nothing else. Every generated
  /// step is named either way: a name is what the reps key on to read the run
  /// block by block, and what the prescription the session carries is checked
  /// against, so leaving one unnamed would cost the run its grouping and hand
  /// the server a prescription it refuses.
  ///
