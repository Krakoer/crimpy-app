  ...
  MigrationStrategy get migration => MigrationStrategy(
    ...
    onUpgrade: stepByStep(
      from1To2: (m, schema) async {
        ...
        await m.addColumn(schema.sessions, schema.sessions.updatedAt);
        await m.addColumn(schema.sessions, schema.sessions.deletedAt);
        await m.addColumn(schema.sessions, schema.sessions.dirty);
        await m.addColumn(schema.sessions, schema.sessions.remoteId);

        await m.addColumn(schema.assessments, schema.assessments.updatedAt);
        await m.addColumn(schema.assessments, schema.assessments.deletedAt);
        await m.addColumn(schema.assessments, schema.assessments.dirty);
        await m.addColumn(schema.assessments, schema.assessments.remoteId);

        await m.addColumn(schema.trainings, schema.trainings.updatedAt);
        await m.addColumn(schema.trainings, schema.trainings.deletedAt);
        await m.addColumn(schema.trainings, schema.trainings.dirty);
        await m.addColumn(schema.trainings, schema.trainings.remoteId);

        await m.addColumn(schema.repeaters, schema.repeaters.updatedAt);
        await m.addColumn(schema.repeaters, schema.repeaters.deletedAt);
        await m.addColumn(schema.repeaters, schema.repeaters.dirty);
        await m.addColumn(schema.repeaters, schema.repeaters.remoteId);

        await m.addColumn(schema.repTemplates, schema.repTemplates.updatedAt);
        await m.addColumn(schema.repTemplates, schema.repTemplates.deletedAt);
        await m.addColumn(schema.repTemplates, schema.repTemplates.dirty);
        await m.addColumn(schema.repTemplates, schema.repTemplates.remoteId);

        await m.addColumn(schema.repDatas, schema.repDatas.updatedAt);
        await m.addColumn(schema.repDatas, schema.repDatas.deletedAt);
        await m.addColumn(schema.repDatas, schema.repDatas.dirty);
        await m.addColumn(schema.repDatas, schema.repDatas.remoteId);

        await m.addColumn(schema.sensorConfigs, schema.sensorConfigs.updatedAt);
        await m.addColumn(schema.sensorConfigs, schema.sensorConfigs.deletedAt);
        await m.addColumn(schema.sensorConfigs, schema.sensorConfigs.dirty);
        await m.addColumn(schema.sensorConfigs, schema.sensorConfigs.remoteId);

        await m.addColumn(
          schema.builtinTrainingWeights,
          schema.builtinTrainingWeights.updatedAt,
        );
        await m.addColumn(
          schema.builtinTrainingWeights,
          schema.builtinTrainingWeights.deletedAt,
        );
        await m.addColumn(
          schema.builtinTrainingWeights,
          schema.builtinTrainingWeights.dirty,
        );
        await m.addColumn(
          schema.builtinTrainingWeights,
          schema.builtinTrainingWeights.remoteId,
        );
        ...
        await m.addColumn(
          schema.pinnedBuiltinTrainings,
          schema.pinnedBuiltinTrainings.dirty,
        );
        await m.addColumn(
          schema.pinnedBuiltinTrainings,
          schema.pinnedBuiltinTrainings.remoteId,
        );
      },
    ),
  );
