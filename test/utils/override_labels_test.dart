...
void main() {
  group('overrideChipLabels', () {
    ...
    test('spells a bodyweight load the way the tile above it does', () {
      // The other unit the coach can express a load in relative terms. Without
      // the bodyweight the chip read "100 %BW" under a tile reading
      // "100 %BW (70 kg)", the same mismatch as the unnamed assessment, one
      // unit along.
      final labels = overrideChipLabels(
        {
          'loads': [
      ...
      expect(labels, ['LOAD 100 %BW (70 kg)']);
    });
  });
}
