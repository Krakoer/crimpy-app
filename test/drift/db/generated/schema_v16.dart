...
class Sessions extends Table with TableInfo<Sessions, SessionsData> {
  ...
  late final GeneratedColumn<int> rpe = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NULL CHECK (rpe BETWEEN 5 AND 10)',
  );
  late final GeneratedColumn<int> rpeFailed = GeneratedColumn<int>(
    'rpe_failed',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class SessionsData extends DataClass implements Insertable<SessionsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['rpe_failed'] = Variable<int>(rpeFailed);
  ...
  factory SessionsData.fromJson(
    ...
    return SessionsData(
      ...
      rpeFailed: serializer.fromJson<int>(json['rpeFailed']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'rpeFailed': serializer.toJson<int>(rpeFailed),
...
class SessionsCompanion extends UpdateCompanion<SessionsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (rpeFailed.present) {
      map['rpe_failed'] = Variable<int>(rpeFailed.value);
    }
